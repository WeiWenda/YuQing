...
public class Linear {
    ...
    /**
     * @throws IllegalArgumentException if model is not probabilistic (see {@link org.apache.lib.Model#isProbabilityModel()})
     */
        ...
        try {
            ...
            for (int i = 0; i < w_size; i++) {
                for (int j = 0; j < nr_w; j++) {
                    ...
                    /** this optimization is the reason for {@link org.apache.lib.Model#equals(double[], double[])} */
                    if (value == 0.0) {
